...
<?php
	...
	//lire des informations
		$requete= $bdd->query('SELECT * FROM `clientele` WHERE `statut`="valider" OR `statut`="solder" OR `statut`="pas encore solder"');
		...
		while($donnees = $requete->fetch()){
			echo '<tr>
					...
					<td><a href="update.php?id='.$donnees['id'].'">modifier</td>
